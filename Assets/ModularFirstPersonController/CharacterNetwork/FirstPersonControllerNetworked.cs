...
public class FirstPersonControllerNetworked : NetworkBehaviour
{
...
// Custom Editor
#if UNITY_EDITOR
    [CustomEditor(typeof(FirstPersonControllerNetworked)), InitializeOnLoadAttribute]
    public class FirstPersonControllerNetworkedEditor : Editor
    {
    FirstPersonControllerNetworked fpc;
    SerializedObject SerFPC;

    private void OnEnable()
    {
        fpc = (FirstPersonControllerNetworked)target;
